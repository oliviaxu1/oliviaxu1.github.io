...
I am **Aoao (Olivia) Xu**, a finance graduate with research interests in **empirical asset pricing, sustainable finance, financial machine learning, and computational analysis of corporate disclosures**.

My academic background combines **finance, econometrics, portfolio analysis, machine learning, natural language processing (NLP), and large language models (LLMs)**. I have published **two peer-reviewed journal articles** and completed multiple research-oriented projects involving machine learning, portfolio construction, financial textual analysis, panel-data econometrics, and LLM-based information extraction.

My proposed doctoral research investigates whether **AI-enabled measurement of ESG disclosure credibility** provides incremental information for asset pricing and firm risk.

I am currently seeking **PhD opportunities** in Finance, Financial Economics, Financial Machine Learning, and AI applications in Finance.
...
- Sustainable Finance
- ESG Disclosure Credibility & Greenwashing
...
**Jiangsu Provincial Government Scholarship for Overseas Study**  
Jiangsu Provincial Government | 2023

**Vice-Chancellor's International Scholarship – Academic Excellence**  
Macquarie University | 2022

**First-Class Scholarship**  
Jiangsu University | 2021, 2022
...
## Machine Learning-Based Return Prediction and Portfolio Construction
**Applied Machine Learning in Finance**, The University of Melbourne | Oct 2025
...
**Data Analysis for Finance**, The University of Melbourne | May 2025
...
**Applied Investment Management**, The University of Melbourne | May 2025
...
| **Category** | **Skills** |
|:-------------|:-----------|
| **Programming & Data Analysis** | Python (pandas, NumPy, scikit-learn), R, STATA, EViews |
| **Machine Learning** | Ridge regression, hyperparameter tuning, time-series cross-validation, rolling-window estimation, cross-sectional return prediction, out-of-sample model evaluation |
| **Financial NLP** | Large Language Model APIs (Google Gemini), prompt engineering, information extraction, sentiment classification, textual variable construction |
| **Empirical Finance & Econometrics** | Panel regression, firm and time fixed effects, clustered standard errors, winsorisation, rolling CAPM beta estimation |
| **Asset Pricing & Investments** | Multi-factor investing, characteristic-sorted portfolios, portfolio optimisation, risk-adjusted performance evaluation, Sharpe ratio analysis |
| **Financial Operations** | Transaction, position and portfolio reconciliation, break investigation, exception management, financial data quality control |
